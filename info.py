...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "7404203924").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "RDX_PVT_LTD"
...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002598175852").split()
]
...
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/MC_MOVIES_PVT")
...
SHORTENER_API = environ.get("SHORTENER_API", "b6bb98c53bd7557c1adcd560f04381306e3df082")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "linkshortify.com")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "b6bb98c53bd7557c1adcd560f04381306e3df082"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "linkshortify.com")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "b6bb98c53bd7557c1adcd560f04381306e3df082"
)
